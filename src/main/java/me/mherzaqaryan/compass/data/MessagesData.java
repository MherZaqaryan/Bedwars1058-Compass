        ...
        for (Language l : Language.getLanguages()) {
            ...
            switch (l.getIso()) {
                ...
                case "ru":
                    ...
                    saveItem(yml, ConfigData.COMPASS_ITEM, "&aКомпас &7(ПКМ)");
                    yml.addDefault(MAIN_MENU_TITLE, "&8Трекер и коммуникации");
                    saveItem(yml, ConfigData.MAIN_MENU_TRACKER, "&aМагазин трекеров", "&7Обновление отслеживания покупок", "&7для вашего компаса, который будет", "&7отслеживать каждого игрока на", "&7конкретная команда, пока вы" , "&7умри.", "", "&eНажмите, чтобы открыть!");
                    saveItem(yml, ConfigData.MAIN_MENU_TRACKER_TEAM, "&aМагазин трекеров", "&7Обновление отслеживания покупок", "&7для вашего компаса, который будет", "&7отслеживать каждого игрока на", "&7конкретная команда, пока вы" , "&7умри.", "", "&eНажмите, чтобы открыть!");
                    saveItem(yml, ConfigData.MAIN_MENU_COMMUNICATIONS, "&aБыстрое общение", "&7Отправить выделенный чат", "&7сообщения своим товарищам", "&7по команде!", "", "&eНажмите, чтобы открыть!");
                    yml.addDefault(TRACKER_MENU_TITLE, "&8Покупка Враг Трекер");
                    saveItem(yml, ConfigData.TRACKER_MENU_TEAM_ITEM, "&cКоманда трека {team}", "&7Обновление отслеживания покупок" , "&7для вашего компаса, который будет" , "&7отслеживать каждого игрока на", "&7конкретная команда, пока вы", "&7умри.", "", "&7Расходы: &22 Изумруды", "", "{status}");
                    saveItem(yml, ConfigData.TRACKER_MENU_BACK_ITEM, "&aВернитесь назад", "&7К трекеру и связи");
                    yml.addDefault(COMMUNICATIONS_MENU_TITLE, "&8Быстрое общение");
                    saveItem(yml, ConfigData.COMMUNICATIONS_MENU_BACK, "&aВернитесь назад", "&7К трекеру и связи");
                    ...
                    saveItem(yml, ConfigData.COMMUNICATIONS_MENU_TEAMS + ".back-item", "&aВернитесь назад" , "&7К быстрой связи!" );
                    yml.addDefault(COMMUNICATIONS_MENU_RESOURCES_TITLE, "&8Выберите вариант:");
                    saveItem(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".back-item", "&aВернитесь назад", "&7К быстрой связи!");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".iron", "&f&lУТЮГ");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".gold", "&6&lЗОЛОТО");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".diamond", "&b&lАЛМАЗ");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".emerald", "&2&lИЗУМРУД");
                    break;
                ...
                case "pl":
                    ...
                    saveItem(yml, ConfigData.COMPASS_ITEM, "&aKompas &7(PRM)");
                    yml.addDefault(MAIN_MENU_TITLE, "&8Namierzanie i komunikacja");
                    saveItem(yml, ConfigData.MAIN_MENU_TRACKER, "&aNamierzanie", "&7Kupując namierzanie drużyny", "&7jesteś przekonany, że", "&7dojdziesz do wroga", "&7Stracisz namierzanie", "&7jeśli umrzesz.", "", "&eKliknij, aby otworzyc!");
                    saveItem(yml, ConfigData.MAIN_MENU_TRACKER_TEAM, "&aNamierzanie", "&7Kupując namierzanie drużyny", "&7jesteś przekonany, że", "&7dojdziesz do wroga", "&7Stracisz namierzanie", "&7jeśli umrzesz.", "", "&eKliknij, aby otworzyc!");
                    saveItem(yml, ConfigData.MAIN_MENU_COMMUNICATIONS, "&aSzybka komunikacja", "&7Kontaktuj się ze", "&7swoją drużymą!", "", "&eKliknik, aby otworzyć!");
                    yml.addDefault(TRACKER_MENU_TITLE, "&8Kup namierzanie");
                    saveItem(yml, ConfigData.TRACKER_MENU_TEAM_ITEM, "&cNamierzaj drużynę {team}", "&7Kupując namierzanie drużyny", "&7jesteś przekonany, że", "&7dojdziesz do wroga.", "&7Wszystkie łóżka muszą zostać", "&7zniszczone, aby użyc namierzania.", "", "&7Cena: &22 Emeraldy", "", "{status}");
                    saveItem(yml, ConfigData.TRACKER_MENU_BACK_ITEM, "&aPowrot", "&7Powraca ciebie do głównej strony");
                    yml.addDefault(COMMUNICATIONS_MENU_TITLE, "&aSzybka komunikacja");
                    saveItem(yml, ConfigData.COMMUNICATIONS_MENU_BACK, "&aPowrot", "&7Powraca ciebie do głównej strony");
                    ...
                    saveItem(yml, ConfigData.COMMUNICATIONS_MENU_TEAMS + ".back-item", "&aPowrot", "&7Powraca ciebie do szybkiej komunimacji");
                    yml.addDefault(COMMUNICATIONS_MENU_RESOURCES_TITLE, "&8Wybierz opcję:");
                    saveItem(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".back-item", "&aPowrot", "&7Powraca ciebie do szybkiej komunimacji");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".iron", "&f&lZELAZO");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".gold", "&6&lZLOTO");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".diamond", "&b&lDIAMENT");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".emerald", "&2&lSZMARAGD");
                ...
                case "ro":
                    ...
                    saveItem(yml, ConfigData.COMPASS_ITEM, "&aCompas &7(Click Dreapta)");
                    yml.addDefault(MAIN_MENU_TITLE, "&8Tracker & Communications");
                    saveItem(yml, ConfigData.MAIN_MENU_TRACKER, "&aMagazin de Trackere", "&7Cumpara tracker upgrades", "&7pentru compasul care va", "&7urmarii jucatorii dintr-o", "&7echipa specifica pana cand tu vei", "&7murii.", "", "&eClick sa deschizi!");
                    saveItem(yml, ConfigData.MAIN_MENU_TRACKER_TEAM, "&aMagazin de Trackere", "&7Cumpara tracker upgrades", "&7pentru compasul care va", "&7urmarii jucatorii dintr-o", "&7echipa specifica pana cand tu vei", "&7murii.", "", "&eClick sa deschizi!");
                    saveItem(yml, ConfigData.MAIN_MENU_COMMUNICATIONS, "&aComunicare rapida", "&7Trimite mesaje evidentiate", "&7catre echipa ta!", "", "&eClick sa deschizi!");
                    yml.addDefault(TRACKER_MENU_TITLE, "&8Cumpara tracker inamic");
                    saveItem(yml, ConfigData.TRACKER_MENU_TEAM_ITEM, "&cUrmareste echipa {team}", "&7Cumpara tracker upgrades", "&7pentru compasul care va", "&7urmarii jucatorii dintr-o", "&7echipa specifica pana cand tu vei", "&7murii.", "", "&7Cost: &22 Emeralde", "", "{status}");
                    saveItem(yml, ConfigData.TRACKER_MENU_BACK_ITEM, "&aDu-te inapoi", "&7To Tracker & Communication");
                    yml.addDefault(COMMUNICATIONS_MENU_TITLE, "&8Comunicare Rapida");
                    saveItem(yml, ConfigData.COMMUNICATIONS_MENU_BACK, "&aDu-te inapoi", "&7To Tracker & Communication");
                    ...
                    saveItem(yml, ConfigData.COMMUNICATIONS_MENU_TEAMS + ".back-item", "&aDu-te inapoi", "&7Catre comunicare rapida");
                    yml.addDefault(COMMUNICATIONS_MENU_RESOURCES_TITLE, "&8Selecteaza o optiune:");
                    saveItem(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".back-item", "&aDu-te inapoi", "&7Catre comunicare rapida");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".iron", "&f&lFIER");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".gold", "&6&lAUR");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".diamond", "&b&lDIAMANT");
                ...
                case "it":
                    ...
                    saveItem(yml, ConfigData.COMPASS_ITEM, "&aBussola &7(Click destro)");
                    yml.addDefault(MAIN_MENU_TITLE, "&8Tracker & Comunicazioni");
                    saveItem(yml, ConfigData.MAIN_MENU_TRACKER, "&aAcquista il tracker", "&7Compra l'aggiornamento Tracker", "&7che ci penserà la tua bussola a farlo", "&7Rintraccia ogni giocatore in una", "&7squadra specifica fino alla", "&7tua morte!.", "", "&eClicca per aprire!");
                    saveItem(yml, ConfigData.MAIN_MENU_TRACKER_TEAM, "&aAcquista il tracker", "&7Compra l'aggiornamento Tracker", "&7che ci penserà la tua bussola a farlo", "&7Rintraccia ogni giocatore in una", "&7squadra specifica fino alla", "&7tua morte!.", "", "&eClicca per aprire!");
                    saveItem(yml, ConfigData.MAIN_MENU_COMMUNICATIONS, "&aComunicazioni veloci", "&7Invia una chat evidenziata", "&7messaggi ai tuoi compagni di squadra!", "", "&eClicca per aprire!");
                    yml.addDefault(TRACKER_MENU_TITLE, "&8Compra il player Tracker");
                    saveItem(yml, ConfigData.TRACKER_MENU_TEAM_ITEM, "&cRintraccia la squadra {team}", "&7Compra l'aggiornamento Tracker", "&7che ci penserà la tua bussola a farlo", "&7Rintraccia ogni giocatore in una", "&7squadra specifica fino alla", "&7tua morte!.", "", "&7Costo: &22 Smeraldi", "", "{status}");
                    saveItem(yml, ConfigData.TRACKER_MENU_BACK_ITEM, "&aTorna indietro", "&7To Tracker & Comunicazioni");
                    yml.addDefault(COMMUNICATIONS_MENU_TITLE, "&8Comunicazioni veloci");
                    saveItem(yml, ConfigData.COMMUNICATIONS_MENU_BACK, "&aTorna indietro", "&7To Tracker & Comunicazioni");
                    ...
                    saveItem(yml, ConfigData.COMMUNICATIONS_MENU_TEAMS + ".back-item", "&aIndietro!", "&7Comunicazioni rapide");
                    yml.addDefault(COMMUNICATIONS_MENU_RESOURCES_TITLE, "&8Scegli un'opzione:");
                    saveItem(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".back-item", "&aTorna indietro!", "&7Comunicazioni rapide");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".iron", "&f&lFERRO");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".gold", "&6&lORO");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".diamond", "&b&lDIAMANTE");
                    saveResource(yml, ConfigData.COMMUNICATIONS_MENU_RESOURCES + ".emerald", "&2&lSMERALDO");
