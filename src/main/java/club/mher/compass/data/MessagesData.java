...
public class MessagesData {
    ...
    public void setupMessages() {
        for (Object l : Compass.getBedWars().getLanguages()) {
            YamlConfiguration yml = Compass.getBedWars().getYml(l);
            switch (Compass.getBedWars().getIso(l)) {
                // By Sxhqil (Persian)
                case "fa":
                    ...
                    saveItem(yml, BW1058MainConfig.COMPASS_ITEM, "&aCompass &7(Rast Click)");
                    saveItem(yml, BW1058MainConfig.TRACKER_SHOP, "&aForooshgahe Tracker ", "&7Yek Tracker Bekhar Ta","&7Az Compasset Baraye Track Kardane","&7Harif Estefade Kon","&7In Ghabeliat Ta Vaqty Hast Ke Bemiri");
                    yml.addDefault(MAIN_MENU_TITLE, "&8Tracker & Communications");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_TRACKER, "&aForooshgahe Tracker ", "&7Yek Tracker Bekhar Ta","&7Az Compasset Baraye Track Kardane","&7Harif Estefade Kon","&7In Ghabeliat Ta Vaqty Hast Ke Bemiri", "", "&eClick Kon Ta Baz She!");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_TRACKER_TEAM, "&aForooshgahe Tracker ", "&7Yek Tracker Bekhar Ta","&7Az Compasset Baraye Track Kardane","&7Harif Estefade Kon","&7In Ghabeliat Ta Vaqty Hast Ke Bemiri", "", "&eClick Kon Ta Baz She!");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_COMMUNICATIONS, "&aQuick Communications", "&7Yek Payame Moshkhas Shode", "&7Baraye Ham Teami Yat Befres!", "", "&eClick Kon Ta Baz She!");
                    yml.addDefault(TRACKER_MENU_TITLE, "&8Kharide Enemy Tracker");
                    saveItem(yml, BW1058MainConfig.TRACKER_MENU_TEAM_ITEM, "&cTrack Kardane Teame {team}", "&7Yek Tracker Bekhar Ta","&7Az Compasset Baraye Track Kardane","&7Harif Estefade Kon","&7In Ghabeliat Ta Vaqty Hast Ke Bemiri", "", "&7Cost: &22 Emeralds", "", "{status}");
                    saveItem(yml, BW1058MainConfig.TRACKER_MENU_BACK_ITEM, "&aBargasht", "&7Be Tracker & Communication");
                    yml.addDefault(COMMUNICATIONS_MENU_TITLE, "&8Ertebate Sarry!");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_BACK, "&aBargasht", "&7Be Tracker & Communication");
                    if (yml.getString(PATH + BW1058MainConfig.COMMUNICATIONS_MENU_ITEMS) == null) {
                    ...
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_TEAMS + ".back-item", "&aBargasht", "&7Be Quick Communications");
                    yml.addDefault(COMMUNICATIONS_MENU_RESOURCES_TITLE, "&8Select an option:");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".back-item", "&aBargasht", "&7Be Quick Communications");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".iron", "&f&lIRON");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".gold", "&6&lGOLD");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".diamond", "&b&lDIAMOND");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".emerald", "&2&lEMERALD");
                case "es":
                    ...
                    yml.addDefault(TEAM_MESSAGE_FORMAT, "&a&lTEAM > &7{player}: {message}");
                    saveItem(yml, BW1058MainConfig.COMPASS_ITEM, "&aBrujula &7(Click Derecho)");
                    saveItem(yml, BW1058MainConfig.TRACKER_SHOP, "&aTracker Shop", "&7Purchase tracking update for","&7your compass which will track","&7each player on a specific team","&7until you die.");
                    yml.addDefault(MAIN_MENU_TITLE, "&7Comunicación rápida y rastreador");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_TRACKER, "&aTienda de rastreadores", "&7Compra la habilidad de rastrear", "&7para tu brújula", "&7rastreando a cada jugador en un", "&7equipo específico hasta", "&7que mueras.", "", "&eClick para abrir!");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_TRACKER_TEAM, "&aTienda de rastreadores", "&7Compra la habilidad de rastrear", "&7para tu brújula", "&7rastreando a cada jugador en un", "&7equipo específico hasta", "&7que mueras.", "", "&eClick para abrir!");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_COMMUNICATIONS, "&aComunicación rápida", "&7Envía un chat rápido a", "&7tu equipo!", "", "&eClick para abrir!");
                    yml.addDefault(TRACKER_MENU_TITLE, "&8Comprar rastreador de enemigos");
                    saveItem(yml, BW1058MainConfig.TRACKER_MENU_TEAM_ITEM, "&cRastrear equipo {team}", "&7Compra la habilidad de rastrear", "&7para tu brújula", "&7rastreando a cada jugador en un", "&7equipo específico hasta", "&7que mueras.", "", "&7Precio: &22 Emeralds", "", "{status}");
                    saveItem(yml, BW1058MainConfig.TRACKER_MENU_BACK_ITEM, "&aAtrás", "&7A Comunicación rápida y rastreador");
                    yml.addDefault(COMMUNICATIONS_MENU_TITLE, "&8Comunicación rapída");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_BACK, "&aAtrás", "&7A Comunicación rápida y rastreador");
                    if (yml.getString(PATH + BW1058MainConfig.COMMUNICATIONS_MENU_ITEMS) == null) {
                    ...
                    yml.addDefault(COMMUNICATIONS_MENU_TEAMS_TITLE, "&8Select an option:");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_TEAMS + ".back-item", "&aVolver", "&7A comunicacion rápida");
                    yml.addDefault(COMMUNICATIONS_MENU_RESOURCES_TITLE, "&8Selecciona una accion:");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".back-item", "&aVolver", "&7A comunicacion rápida");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".iron", "&f&lHIERRO");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".gold", "&6&lORO");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".diamond", "&b&lDIAMANTES");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".emerald", "&2&lESMERALDAS");
                    break;
                case "ru":
                    ...
                    saveItem(yml, BW1058MainConfig.COMPASS_ITEM, "&aКомпас &7(ПКМ)");
                    saveItem(yml, BW1058MainConfig.TRACKER_SHOP, "&aTracker Shop", "&7Purchase tracking update for","&7your compass which will track","&7each player on a specific team","&7until you die.");
                    yml.addDefault(MAIN_MENU_TITLE, "&8Трекер и коммуникации");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_TRACKER, "&aМагазин трекеров", "&7Обновление отслеживания покупок", "&7для вашего компаса, который будет", "&7отслеживать каждого игрока на", "&7конкретная команда, пока вы" , "&7умри.", "", "&eНажмите, чтобы открыть!");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_TRACKER_TEAM, "&aМагазин трекеров", "&7Обновление отслеживания покупок", "&7для вашего компаса, который будет", "&7отслеживать каждого игрока на", "&7конкретная команда, пока вы" , "&7умри.", "", "&eНажмите, чтобы открыть!");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_COMMUNICATIONS, "&aБыстрое общение", "&7Отправить выделенный чат", "&7сообщения своим товарищам", "&7по команде!", "", "&eНажмите, чтобы открыть!");
                    yml.addDefault(TRACKER_MENU_TITLE, "&8Покупка Враг Трекер");
                    saveItem(yml, BW1058MainConfig.TRACKER_MENU_TEAM_ITEM, "&cКоманда трека {team}", "&7Обновление отслеживания покупок" , "&7для вашего компаса, который будет" , "&7отслеживать каждого игрока на", "&7конкретная команда, пока вы", "&7умри.", "", "&7Расходы: &22 Изумруды", "", "{status}");
                    saveItem(yml, BW1058MainConfig.TRACKER_MENU_BACK_ITEM, "&aВернитесь назад", "&7К трекеру и связи");
                    yml.addDefault(COMMUNICATIONS_MENU_TITLE, "&8Быстрое общение");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_BACK, "&aВернитесь назад", "&7К трекеру и связи");
                    if (yml.getString(PATH + BW1058MainConfig.COMMUNICATIONS_MENU_ITEMS) == null) {
                    ...
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_TEAMS + ".back-item", "&aВернитесь назад" , "&7К быстрой связи!" );
                    yml.addDefault(COMMUNICATIONS_MENU_RESOURCES_TITLE, "&8Выберите вариант:");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".back-item", "&aВернитесь назад", "&7К быстрой связи!");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".iron", "&f&lУТЮГ");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".gold", "&6&lЗОЛОТО");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".diamond", "&b&lАЛМАЗ");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".emerald", "&2&lИЗУМРУД");
                    break;
                ...
                case "pl":
                    ...
                    saveItem(yml, BW1058MainConfig.COMPASS_ITEM, "&aKompas &7(PRM)");
                    saveItem(yml, BW1058MainConfig.TRACKER_SHOP, "&aTracker Shop", "&7Purchase tracking update for","&7your compass which will track","&7each player on a specific team","&7until you die.");
                    yml.addDefault(MAIN_MENU_TITLE, "&8Namierzanie i komunikacja");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_TRACKER, "&aNamierzanie", "&7Kupując namierzanie drużyny", "&7jesteś przekonany, że", "&7dojdziesz do wroga", "&7Stracisz namierzanie", "&7jeśli umrzesz.", "", "&eKliknij, aby otworzyc!");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_TRACKER_TEAM, "&aNamierzanie", "&7Kupując namierzanie drużyny", "&7jesteś przekonany, że", "&7dojdziesz do wroga", "&7Stracisz namierzanie", "&7jeśli umrzesz.", "", "&eKliknij, aby otworzyc!");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_COMMUNICATIONS, "&aSzybka komunikacja", "&7Kontaktuj się ze", "&7swoją drużymą!", "", "&eKliknik, aby otworzyć!");
                    yml.addDefault(TRACKER_MENU_TITLE, "&8Kup namierzanie");
                    saveItem(yml, BW1058MainConfig.TRACKER_MENU_TEAM_ITEM, "&cNamierzaj drużynę {team}", "&7Kupując namierzanie drużyny", "&7jesteś przekonany, że", "&7dojdziesz do wroga.", "&7Wszystkie łóżka muszą zostać", "&7zniszczone, aby użyc namierzania.", "", "&7Cena: &22 Emeraldy", "", "{status}");
                    saveItem(yml, BW1058MainConfig.TRACKER_MENU_BACK_ITEM, "&aPowrot", "&7Powraca ciebie do głównej strony");
                    yml.addDefault(COMMUNICATIONS_MENU_TITLE, "&aSzybka komunikacja");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_BACK, "&aPowrot", "&7Powraca ciebie do głównej strony");
                    if (yml.getString(PATH + BW1058MainConfig.COMMUNICATIONS_MENU_ITEMS) == null) {
                    ...
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_TEAMS + ".back-item", "&aPowrot", "&7Powraca ciebie do szybkiej komunimacji");
                    yml.addDefault(COMMUNICATIONS_MENU_RESOURCES_TITLE, "&8Wybierz opcję:");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".back-item", "&aPowrot", "&7Powraca ciebie do szybkiej komunimacji");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".iron", "&f&lZELAZO");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".gold", "&6&lZLOTO");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".diamond", "&b&lDIAMENT");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".emerald", "&2&lSZMARAGD");
                    break;
                ...
                case "ro":
                    ...
                    saveItem(yml, BW1058MainConfig.COMPASS_ITEM, "&aCompas &7(Click Dreapta)");
                    saveItem(yml, BW1058MainConfig.TRACKER_SHOP, "&aTracker Shop", "&7Purchase tracking update for","&7your compass which will track","&7each player on a specific team","&7until you die.");
                    yml.addDefault(MAIN_MENU_TITLE, "&8Tracker & Communications");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_TRACKER, "&aMagazin de Trackere", "&7Cumpara tracker upgrades", "&7pentru compasul care va", "&7urmarii jucatorii dintr-o", "&7echipa specifica pana cand tu vei", "&7murii.", "", "&eClick sa deschizi!");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_TRACKER_TEAM, "&aMagazin de Trackere", "&7Cumpara tracker upgrades", "&7pentru compasul care va", "&7urmarii jucatorii dintr-o", "&7echipa specifica pana cand tu vei", "&7murii.", "", "&eClick sa deschizi!");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_COMMUNICATIONS, "&aComunicare rapida", "&7Trimite mesaje evidentiate", "&7catre echipa ta!", "", "&eClick sa deschizi!");
                    yml.addDefault(TRACKER_MENU_TITLE, "&8Cumpara tracker inamic");
                    saveItem(yml, BW1058MainConfig.TRACKER_MENU_TEAM_ITEM, "&cUrmareste echipa {team}", "&7Cumpara tracker upgrades", "&7pentru compasul care va", "&7urmarii jucatorii dintr-o", "&7echipa specifica pana cand tu vei", "&7murii.", "", "&7Cost: &22 Emeralde", "", "{status}");
                    saveItem(yml, BW1058MainConfig.TRACKER_MENU_BACK_ITEM, "&aDu-te inapoi", "&7To Tracker & Communication");
                    yml.addDefault(COMMUNICATIONS_MENU_TITLE, "&8Comunicare Rapida");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_BACK, "&aDu-te inapoi", "&7To Tracker & Communication");
                    if (yml.getString(PATH + BW1058MainConfig.COMMUNICATIONS_MENU_ITEMS) == null) {
                    ...
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_TEAMS + ".back-item", "&aDu-te inapoi", "&7Catre comunicare rapida");
                    yml.addDefault(COMMUNICATIONS_MENU_RESOURCES_TITLE, "&8Selecteaza o optiune:");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".back-item", "&aDu-te inapoi", "&7Catre comunicare rapida");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".iron", "&f&lFIER");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".gold", "&6&lAUR");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".diamond", "&b&lDIAMANT");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".emerald", "&2&lEMERALD");
                    break;
                ...
                case "it":
                    ...
                    yml.addDefault(TEAM_MESSAGE_FORMAT, "&a&lTEAM > &7{player}: {message}");
                    saveItem(yml, BW1058MainConfig.COMPASS_ITEM, "&aBussola &7(Click destro)");
                    saveItem(yml, BW1058MainConfig.TRACKER_SHOP, "&aTracker Shop", "&7Purchase tracking update for","&7your compass which will track","&7each player on a specific team","&7until you die.");
                    yml.addDefault(MAIN_MENU_TITLE, "&8Tracker & Comunicazioni");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_TRACKER, "&aAcquista il tracker", "&7Compra l'aggiornamento Tracker", "&7che ci penserà la tua bussola a farlo", "&7Rintraccia ogni giocatore in una", "&7squadra specifica fino alla", "&7tua morte!.", "", "&eClicca per aprire!");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_TRACKER_TEAM, "&aAcquista il tracker", "&7Compra l'aggiornamento Tracker", "&7che ci penserà la tua bussola a farlo", "&7Rintraccia ogni giocatore in una", "&7squadra specifica fino alla", "&7tua morte!.", "", "&eClicca per aprire!");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_COMMUNICATIONS, "&aComunicazioni veloci", "&7Invia una chat evidenziata", "&7messaggi ai tuoi compagni di squadra!", "", "&eClicca per aprire!");
                    yml.addDefault(TRACKER_MENU_TITLE, "&8Compra il player Tracker");
                    saveItem(yml, BW1058MainConfig.TRACKER_MENU_TEAM_ITEM, "&cRintraccia la squadra {team}", "&7Compra l'aggiornamento Tracker", "&7che ci penserà la tua bussola a farlo", "&7Rintraccia ogni giocatore in una", "&7squadra specifica fino alla", "&7tua morte!.", "", "&7Costo: &22 Smeraldi", "", "{status}");
                    saveItem(yml, BW1058MainConfig.TRACKER_MENU_BACK_ITEM, "&aTorna indietro", "&7To Tracker & Comunicazioni");
                    yml.addDefault(COMMUNICATIONS_MENU_TITLE, "&8Comunicazioni veloci");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_BACK, "&aTorna indietro", "&7To Tracker & Comunicazioni");
                    if (yml.getString(PATH + BW1058MainConfig.COMMUNICATIONS_MENU_ITEMS) == null) {
                    ...
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_TEAMS + ".back-item", "&aIndietro!", "&7Comunicazioni rapide");
                    yml.addDefault(COMMUNICATIONS_MENU_RESOURCES_TITLE, "&8Scegli un'opzione:");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".back-item", "&aTorna indietro!", "&7Comunicazioni rapide");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".iron", "&f&lFERRO");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".gold", "&6&lORO");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".diamond", "&b&lDIAMANTE");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".emerald", "&2&lSMERALDO");
                    break;
                ...
                default:
                    ...
                    yml.addDefault(ACTION_BAR_TRACKING, "&fTracking: {teamColor}&l{target} &f- Distance: &a&l{distance}m");
                    yml.addDefault(TEAM_MESSAGE_FORMAT, "&a&lTEAM > &7{player}: {message}");
                    saveItem(yml, BW1058MainConfig.COMPASS_ITEM, "&aCompass &7(Right Click)");
                    saveItem(yml, BW1058MainConfig.TRACKER_SHOP, "&aTracker Shop", "&7Purchase tracking update for","&7your compass which will track","&7each player on a specific team","&7until you die.");
                    yml.addDefault(MAIN_MENU_TITLE, "&8Tracker & Communications");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_TRACKER, "&aTracker Shop", "&7Purchase tracking upgrade", "&7for your compass which will", "&7track each player on a", "&7specific team until you", "&7die.", "", "&eClick to open!");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_TRACKER_TEAM, "&aTracker Shop", "&7Purchase tracking upgrade", "&7for your compass which will", "&7track each player on a", "&7specific team until you", "&7die.", "", "&eClick to open!");
                    saveItem(yml, BW1058MainConfig.MAIN_MENU_COMMUNICATIONS, "&aQuick Communications", "&7Send highlighted chat", "&7messages to your teammates!", "", "&eClick to open!");
                    yml.addDefault(TRACKER_MENU_TITLE, "&8Purchase Enemy Tracker");
                    saveItem(yml, BW1058MainConfig.TRACKER_MENU_TEAM_ITEM, "&cTrack Team {team}", "&7Purchase tracking upgrade", "&7for your compass which will", "&7track each player on a", "&7specific team until you", "&7die.", "", "&7Cost: &22 Emeralds", "", "{status}");
                    saveItem(yml, BW1058MainConfig.TRACKER_MENU_BACK_ITEM, "&aGo Back", "&7To Tracker & Communication");
                    yml.addDefault(COMMUNICATIONS_MENU_TITLE, "&8Quick Communications");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_BACK, "&aGo Back", "&7To Tracker & Communication");
                    if (yml.getString(PATH + BW1058MainConfig.COMMUNICATIONS_MENU_ITEMS) == null) {
                    ...
                    yml.addDefault(COMMUNICATIONS_MENU_TEAMS_TITLE, "&8Select an option:");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_TEAMS + ".back-item", "&aGo Back", "&7To Quick Communications");
                    yml.addDefault(COMMUNICATIONS_MENU_RESOURCES_TITLE, "&8Select an option:");
                    saveItem(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".back-item", "&aGo Back", "&7To Quick Communications");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".iron", "&f&lIRON");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".gold", "&6&lGOLD");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".diamond", "&b&lDIAMOND");
                    saveResource(yml, BW1058MainConfig.COMMUNICATIONS_MENU_RESOURCES + ".emerald", "&2&lEMERALD");
            ...
            Compass.getBedWars().getYml(l).options().copyDefaults(true);
            Compass.getBedWars().save(l);
        }
    }

    public static Object getLang(Player player) {
        return Compass.getBedWars().getPlayerLanguage(player);
    }

    public static YamlConfiguration getYml(Player player) {
        return Compass.getBedWars().getYml(getLang(player));
    }
    ...
    private void saveCommunicationItem(YamlConfiguration yml, String path, String message, String displayName, String... lore) {
        path = PATH + BW1058MainConfig.COMMUNICATIONS_MENU_ITEMS +"."+ path;
