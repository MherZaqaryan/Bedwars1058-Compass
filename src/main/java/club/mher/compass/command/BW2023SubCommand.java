...
public class BW2023SubCommand extends SubCommand {

    public BW2023SubCommand(ParentCommand parent, String name) {
        super(parent, name);
        showInList(true);
    ...
    public boolean execute(String[] args, CommandSender sender) {
        if (sender instanceof Player) {
            ...
            if (args.length == 0) {
                ...
                Arrays.asList(
                        TextUtil.msgHoverClick("&8&lþ &6BedWars2023 Compass v" + Compass.PLUGIN_VERSION + " &7- &cAdmin Commands", "&7Author: &cMher Zaqaryan", "https://www.spigotmc.org/resources/91537/", ClickEvent.Action.OPEN_URL),
                        TextUtil.blank(),
